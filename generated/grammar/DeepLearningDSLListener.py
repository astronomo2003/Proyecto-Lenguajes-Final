...
class DeepLearningDSLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by DeepLearningDSLParser#list_expr.
    def enterList_expr(self, ctx:DeepLearningDSLParser.List_exprContext):
        pass

    # Exit a parse tree produced by DeepLearningDSLParser#list_expr.
    def exitList_expr(self, ctx:DeepLearningDSLParser.List_exprContext):
        pass
